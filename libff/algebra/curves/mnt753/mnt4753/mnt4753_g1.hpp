...
public:
    ...
    mnt4753_G1();
    mnt4753_G1(const mnt4753_Fq& X, const mnt4753_Fq& Y) : X(X), Y(Y), Z(base_field::one()) {}
    mnt4753_G1(const mnt4753_Fq& X, const mnt4753_Fq& Y, const mnt4753_Fq& Z) : X(X), Y(Y), Z(Z) {}
