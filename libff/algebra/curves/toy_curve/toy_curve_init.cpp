...
void init_toy_curve_params()
{
    ...
    toy_curve_Fq6::non_residue = toy_curve_Fq2(toy_curve_Fq("2"),toy_curve_Fq("1"));
    toy_curve_Fq6::Frobenius_coeffs_c1[0] = toy_curve_Fq2(toy_curve_Fq("1"),toy_curve_Fq("0"));
    toy_curve_Fq6::Frobenius_coeffs_c1[1] = toy_curve_Fq2(toy_curve_Fq("1199867752729316448016774"),toy_curve_Fq("238034680536228445107023"));
    toy_curve_Fq6::Frobenius_coeffs_c1[2] = toy_curve_Fq2(toy_curve_Fq("1211206631481375689556416"),toy_curve_Fq("0"));
    toy_curve_Fq6::Frobenius_coeffs_c1[3] = toy_curve_Fq2(toy_curve_Fq("1179867936188319721484957"),toy_curve_Fq("523979024485397284119846"));
    toy_curve_Fq6::Frobenius_coeffs_c1[4] = toy_curve_Fq2(toy_curve_Fq("1414034297008940566"),toy_curve_Fq("0"));
    toy_curve_Fq6::Frobenius_coeffs_c1[5] = toy_curve_Fq2(toy_curve_Fq("42680402113709227492235"),toy_curve_Fq("449194340494046969270114"));
    toy_curve_Fq6::Frobenius_coeffs_c2[0] = toy_curve_Fq2(toy_curve_Fq("1"),toy_curve_Fq("0"));
    toy_curve_Fq6::Frobenius_coeffs_c2[1] = toy_curve_Fq2(toy_curve_Fq("150735987079257040478043"),toy_curve_Fq("665305510425142595241730"));
    toy_curve_Fq6::Frobenius_coeffs_c2[2] = toy_curve_Fq2(toy_curve_Fq("1414034297008940566"),toy_curve_Fq("0"));
    toy_curve_Fq6::Frobenius_coeffs_c2[3] = toy_curve_Fq2(toy_curve_Fq("530979151227808545294494"),toy_curve_Fq("437409500080047630235903"));
    toy_curve_Fq6::Frobenius_coeffs_c2[4] = toy_curve_Fq2(toy_curve_Fq("1211206631481375689556416"),toy_curve_Fq("0"));
    toy_curve_Fq6::Frobenius_coeffs_c2[5] = toy_curve_Fq2(toy_curve_Fq("529492907208607112724446"),toy_curve_Fq("108493035010482473019350"));

    /* parameters for Fq12 */
    toy_curve_Fq12::non_residue = toy_curve_Fq2(toy_curve_Fq("2"),toy_curve_Fq("1"));
    toy_curve_Fq12::Frobenius_coeffs_c1[0]  = toy_curve_Fq2(toy_curve_Fq("1"),toy_curve_Fq("0"));
    toy_curve_Fq12::Frobenius_coeffs_c1[1]  = toy_curve_Fq2(toy_curve_Fq("618083534216606818799103"),toy_curve_Fq("1046554526274906708512242"));
    toy_curve_Fq12::Frobenius_coeffs_c1[2]  = toy_curve_Fq2(toy_curve_Fq("1211206631481375689556417"),toy_curve_Fq("0"));
    toy_curve_Fq12::Frobenius_coeffs_c1[3]  = toy_curve_Fq2(toy_curve_Fq("1067670654340965390800601"),toy_curve_Fq("1094201616934460134822797"));
    toy_curve_Fq12::Frobenius_coeffs_c1[4]  = toy_curve_Fq2(toy_curve_Fq("1211206631481375689556416"),toy_curve_Fq("0"));
    toy_curve_Fq12::Frobenius_coeffs_c1[5]  = toy_curve_Fq2(toy_curve_Fq("449587120124358572001498"),toy_curve_Fq("47647090659553426310555"));
    toy_curve_Fq12::Frobenius_coeffs_c1[6]  = toy_curve_Fq2(toy_curve_Fq("1211208045515672698496982"),toy_curve_Fq("0"));
    toy_curve_Fq12::Frobenius_coeffs_c1[7]  = toy_curve_Fq2(toy_curve_Fq("593124511299065879697880"),toy_curve_Fq("164653519240765989984741"));
    toy_curve_Fq12::Frobenius_coeffs_c1[8]  = toy_curve_Fq2(toy_curve_Fq("1414034297008940566"),toy_curve_Fq("0"));
    toy_curve_Fq12::Frobenius_coeffs_c1[9]  = toy_curve_Fq2(toy_curve_Fq("143537391174707307696382"),toy_curve_Fq("117006428581212563674186"));
    toy_curve_Fq12::Frobenius_coeffs_c1[10] = toy_curve_Fq2(toy_curve_Fq("1414034297008940567"),toy_curve_Fq("0"));
    toy_curve_Fq12::Frobenius_coeffs_c1[11] = toy_curve_Fq2(toy_curve_Fq("761620925391314126495485"),toy_curve_Fq("1163560954856119272186428"));
